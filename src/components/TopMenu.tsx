    ...
    <Dropdown.Item onClick={() => this.handleLanguageSwitch(language)}>
      <Form.Check type="radio" name="language">
        <FontAwesomeIcon
          icon={["fas", "check"]}
          className={
            this.props.i18n.language === language ? "me-1 selected" : "me-1"
          }
        />{" "}
        {label}
      </Form.Check>
  ...
  render() {
    const helpButton = this.props.loggedIn ? (
      <>
        <Button
          ...
          title={this.props.i18n.t("top_menu.help")}
        >
          ...
          <Modal.Body>
            ...
            <Table size="sm" striped bordered>
              ...
              <tbody>
                ...
                <tr>
                  <td>
                    <code>collaborative:true</code>
                  </td>
                  <td>
                    {this.props.i18n.t("help.search_syntax.collaborative_true")}
                  </td>
                </tr>
                <tr>
                  <td>
                    <code>collaborative:false</code>
                  </td>
                  <td>
                    {this.props.i18n.t(
                      "help.search_syntax.collaborative_false"
                    )}
                  </td>
                </tr>
                <tr>
                ...
                <tr>
                  ...
                  <td>
                    <Trans
                      i18nKey="help.search_syntax.owner_owner"
    ...
    const logoutButton = this.props.loggedIn ? (
      <Button
        ...
        title={this.props.i18n.t("top_menu.change_user")}
      >
    ...
    return (
      <div id="topMenu">
        ...
        <Button
          ...
          title={this.props.i18n.t("top_menu.toggle_dark_mode")}
        >
